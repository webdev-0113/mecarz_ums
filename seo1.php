...
if(array_key_exists('country', $_REQUEST) &&
    array_key_exists('state', $_REQUEST) &&
    array_key_exists('city', $_REQUEST) &&
    array_key_exists('category', $_REQUEST) &&
    array_key_exists('make', $_REQUEST) &&
    array_key_exists('model', $_REQUEST) &&
    array_key_exists('search', $_REQUEST) &&
    array_key_exists('changeseo', $_REQUEST)) {
