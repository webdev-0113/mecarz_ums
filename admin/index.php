...
if (file_exists($config['path'].'language/'.$settings_profile['languageadmin']) ) {
    include $config['path'].'language/'.$settings_profile['languageadmin'];
}
*/
...
include $path . "configsettings.php";
...
switch($_REQUEST['p']){
    ...
    case "banner":
        ...
        switch($_REQUEST['p1']){
            ...
            case "bannerstats":
                //$lang['tpl_auto_load_calendar_js'] = $tpl->replace( array(), "calendar1.js", "js" );
                include $path . "bannerstats.class.php";
...
//finish cars
        case "cars":
            ...
            $require_array = $config['admin_section']['cars']['require_array']; //include array
...
//carsfeatures
        case "carsfeatures":
            ...
            $copy_from = array(); // for big pictures
            $copy_from_val = array(); // for big picutres size
            $require_array = array(); //include array
            $password = array(); // for md5 fields
...
//end
                ...
                $require_array = $config['admin_section'][$default_tabel]['require_array']; //include array
